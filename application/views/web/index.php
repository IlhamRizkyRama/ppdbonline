...
<body id="page-top" class="index">
        ...
        <div class="container">
            ...
            <div class="navbar-header page-scroll">
                ...
                <a class="navbar-brand" href="#page-top">
                    <img src="assets/images/logo.png" alt="Logo" width="35" style="position:absolute;margin-top:-10px;">
    ...
    <header>
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <img class="img-responsive" src="assets/images/logo.png" style="margin-top:-15%;margin-bottom:-10px;" width="100">
                    <br><br>
                    <div class="intro-text">
                        <span class="name shad" style="font-size:35px; line-height: 35px;">
                            SELAMAT DATANG DI PENDAFTARAN PPDB ONLINE <br> <?php echo $user['nama_lengkap']; ?>
                        </span>
                        <br>
